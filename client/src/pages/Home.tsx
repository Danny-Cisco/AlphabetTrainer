        ...
        <div className="container max-w-4xl mx-auto px-4 py-8 relative z-10">
          <header className="mb-8">
            <div className="flex justify-between items-center mb-6">
              <div>
                <h1 className="text-3xl font-light text-gray-900 dark:text-gray-100" style={{ fontFamily: 'Zilla Slab, serif' }}>DigitDojo</h1>
                <p className="text-lg font-light text-gray-600 dark:text-gray-400 mt-1" style={{ fontFamily: 'Zilla Slab, serif' }}>Single Character Typing Practice</p>
              </div>
              <ThemeToggle />
            </div>
            ...
            <div className="text-center">
              <div className="flex items-center justify-center gap-6">
                ...
                <div className="min-w-0 flex-1 max-w-lg">
                  <h2 className={`text-5xl md:text-6xl font-light ${belts[currentBeltIndex].color}`} style={{ fontFamily: 'Zilla Slab, serif' }}>
                    🥋 {belts[currentBeltIndex].name}
                  </h2>
                  <p className="text-lg font-light text-gray-600 dark:text-gray-400 mt-2" style={{ fontFamily: 'Zilla Slab, serif' }}>
